...
<body>
		...
		<div
			...
			<nav class="classy-navbar" id="essenceNav">
				...
				<a class="nav-brand"
					...
					src="${pageContext.request.contextPath}/resources/img/core-img/tlogo.png"
					alt=""></a>
				<!-- Navbar Toggler -->
							...
							<li><a href="#">Shop</a>
								<div class="megamenu">
									<ul class="single-mega cn-col-4">
										...
										<li><a
											href="${pageContext.request.contextPath}/shop.html">Dresses</a></li>
										<li><a
											href="${pageContext.request.contextPath}/shop.html">Blouses
												&amp; Shirts</a></li>
										<li><a
											href="${pageContext.request.contextPath}/shop.html">T-shirts</a></li>
										<li><a
											href="${pageContext.request.contextPath}/shop.html">Rompers</a></li>
										<li><a
											href="${pageContext.request.contextPath}/shop.html">Bras
												&amp; Panties</a></li>
									</ul>
									<ul class="single-mega cn-col-4">
										...
										<li><a
											href="${pageContext.request.contextPath}/shop.html">T-Shirts</a></li>
										<li><a
											href="${pageContext.request.contextPath}/shop.html">Polo</a></li>
										<li><a
											href="${pageContext.request.contextPath}/shop.html">Shirts</a></li>
										<li><a
											href="${pageContext.request.contextPath}/shop.html">Jackets</a></li>
										<li><a
											href="${pageContext.request.contextPath}/shop.html">Trench</a></li>
									</ul>
									<ul class="single-mega cn-col-4">
								...
								<ul class="dropdown">
									...
									<li><a
										href="${pageContext.request.contextPath}/single-product-details.html">Product
											Details</a></li>
									<li><a
										href="${pageContext.request.contextPath}/checkout.html">Checkout</a></li>
			...
			<div class="cart-amount-summary">
				...
				<div class="checkout-btn mt-100">
					<a href="${pageContext.request.contextPath}/checkout.html"
						class="btn essence-btn">check out</a>
				</div>
			</div>
		</div>
	</div>
	...
	<section class="welcome_area bg-img background-overlay"
		style="background-image: url(${pageContext.request.contextPath}/resources/img/bg-img/bg-1.jpg);">
			...
			<div class="row">
				<div class="col-12">
					<div class="cta-content bg-img background-overlay"
						style="background-image: url(${pageContext.request.contextPath}/resources/img/bg-img/bg-5.jpg);">
						...
						<c:forEach var="item" items="${items}">
							<div class="single-product-wrapper">
								...
								<div class="product-description">
									<span>topshop</span> <a
										href="${pageContext.request.contextPath}/single-product-details.html">
										<h6>${item.name}</h6>
									</a>
	...
	<div
		...
		<div class="single-brands-logo">
			<img
				src="${pageContext.request.contextPath}/resources/img/core-img/brand1.png"
				alt="">
		</div>
		<!-- Brand Logo -->
		<div class="single-brands-logo">
			<img
				src="${pageContext.request.contextPath}/resources/img/core-img/brand2.png"
				alt="">
		</div>
		<!-- Brand Logo -->
		<div class="single-brands-logo">
			<img
				src="${pageContext.request.contextPath}/resources/img/core-img/brand3.png"
				alt="">
		</div>
		<!-- Brand Logo -->
		<div class="single-brands-logo">
			<img
				src="${pageContext.request.contextPath}/resources/img/core-img/brand4.png"
				alt="">
		</div>
		<!-- Brand Logo -->
		<div class="single-brands-logo">
			<img
				src="${pageContext.request.contextPath}/resources/img/core-img/brand5.png"
				alt="">
		</div>
		<!-- Brand Logo -->
		<div class="single-brands-logo">
			<img
				src="${pageContext.request.contextPath}/resources/img/core-img/brand6.png"
				alt="">
		</div>
	</div>
	<!-- ##### Brands Area End ##### -->
				...
				<div class="col-12 col-md-6">
					<div class="single_widget_area d-flex mb-30">
						...
						<div class="footer-logo mr-50">
							<a href="#"><img
								src="${pageContext.request.contextPath}/resources/img/core-img/t-white-logo.png"
								alt=""></a>
						</div>
						<!-- Footer Menu -->
				...
				<div class="col-md-12 text-center">
					<p>
						...
						All rights reserved | This template is made with <i
							...
							href="javascript:void(0);">Trending Twig</a>
						<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
					</p>
				</div>
			</div>
