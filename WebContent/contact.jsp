    ...
    <div class="contact-area d-flex align-items-center">
        ...
        <div class="contact-info">
            ...
            <div class="contact-address mt-50">
                ...
                <p><a href="${pageContext.request.contextPath}/mailto:contact@essence.com">contact@essence.com</a></p>
            </div>
        </div>
...
<div class="row mt-5">
    ...
    <script src="${pageContext.request.contextPath}/resources/js/map-active.js"></script>
